...
if (DEV_FAMILY STREQUAL "E")
    ...
    if(DEFINED CACHE{ENABLE_${BOARD_ABERRATION_IN_UPPER}_${BOARD_KIT_TYPE_IN_UPPER}_F})
        set("ENABLE_${BOARD_ABERRATION_IN_UPPER}_${BOARD_KIT_TYPE_IN_UPPER}"
            ${ENABLE_${BOARD_ABERRATION_IN_UPPER}_${BOARD_KIT_TYPE_IN_UPPER}_F}
            CACHE   BOOL    "Enable/disable ${BOARD_ABERRATION_IN_UPPER} ${BOARD_KIT_TYPE_IN_UPPER}."   FORCE)
    else()
        set("ENABLE_${BOARD_ABERRATION_IN_UPPER}_${BOARD_KIT_TYPE_IN_UPPER}"       ON
            CACHE   BOOL    "Enable/disable ${BOARD_ABERRATION_IN_UPPER} ${BOARD_KIT_TYPE_IN_UPPER}."   FORCE)
    endif()
