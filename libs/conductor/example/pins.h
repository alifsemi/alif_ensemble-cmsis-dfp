...
const struct pinconf board_pinconf[] = {
	...
	/* Selected: GPIO6_2 */
	{PORT_6, PIN_2, PINMUX_ALTERNATE_FUNCTION_0, PADCTRL_OUTPUT_DRIVE_STRENGTH_04_MILI_AMPS},
	...
	/* Selected: GPIO6_4 */
	{PORT_6, PIN_4, PINMUX_ALTERNATE_FUNCTION_0, PADCTRL_OUTPUT_DRIVE_STRENGTH_04_MILI_AMPS},

	/* P6_6 on pin D16. Functions: [0]: >>>GPIO6_6<<<, [1]: OSPI0_D6_C, [2]: UART0_CTS_B, [3]: Reserved, [4]: SPI1_SS2_B, [5]: UT7_T0_B, [6]: SD_D6_D, [7]: ETH_MDC_A */
	/* Selected: GPIO6_6 */
	{PORT_6, PIN_6, PINMUX_ALTERNATE_FUNCTION_0, PADCTRL_OUTPUT_DRIVE_STRENGTH_04_MILI_AMPS},
	...
	/* Selected: GPIO7_4 */
	{PORT_7, PIN_4, PINMUX_ALTERNATE_FUNCTION_0, PADCTRL_OUTPUT_DRIVE_STRENGTH_04_MILI_AMPS},

	/* P12_0 on pin D2. Functions: [0]: >>>GPIO12_0<<<, [1]: OSPI0_SCLK_C, [2]: AUDIO_CLK_C, [3]: I2S1_SDI_B, [4]: UT8_T0_C, [5]: CDC_D8_B */
	/* Selected: GPIO12_0 */
	{PORT_12, PIN_0, PINMUX_ALTERNATE_FUNCTION_0, PADCTRL_OUTPUT_DRIVE_STRENGTH_04_MILI_AMPS},

	/* P12_3 on pin E7. Functions: [0]: >>>GPIO12_3<<<, [1]: OSPI0_SS0_C, [2]: UART4_DE_B, [3]: I2S1_WS_B, [4]: UT9_T1_C, [5]: CDC_D11_B */
	/* Selected: GPIO12_3 */
	{PORT_12, PIN_3, PINMUX_ALTERNATE_FUNCTION_0, PADCTRL_OUTPUT_DRIVE_STRENGTH_04_MILI_AMPS},
