...
/* HSCMP device specific interrupt status macro for Ex device */
#define DEVICE_FEATURE_HSCMP_INT_STATUS_MASK   1U

/* HSCMP device specific window function macro for Ex device */
#define DEVICE_FEATURE_HSCMP_WINDOW_FUNCTION_ENABLE   3U
