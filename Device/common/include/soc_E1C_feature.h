...
#define DEVICE_FEATURE_LPTIMER_PWM_ENABLED
...
#define DEVICE_FEATURE_GPIO1_FLEXIO_PIN_MASK  ((1U << 3) | (1U << 4) | (1U << 5) | (1U << 6) | (1U << 7))
...
/* CPI cropping and sequential capture control macro for E1C device */
#define DEVICE_FEATURE_CPI_CROP_SEQ_CTRL      1
...
/* HSCMP device specific interrupt status macro for E1 device */
#define DEVICE_FEATURE_HSCMP_INT_STATUS_MASK    3U

/* HSCMP device specific window function macro for E1 device */
#define DEVICE_FEATURE_HSCMP_WINDOW_FUNCTION_ENABLE    1U
